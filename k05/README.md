...
117　stackを初期化
118　出発点をpush
120　stackの中身がなくなるなるまで繰り返す
122　indexにstackから取り出したものを入れる
123～134　訪れたことがなければ訪れたことにして、そこから行ける場所をstackに入れる
139　すべて行ったかチェック
208　visitedを初期化
215　キューを初期化
216　出発点をキューに入れる
218　キューから取り出すものがなくなるまで繰り返す
220　indexにキューから取り出したものを入れる
221～229　訪れたことがなければ訪れたことにして、そこから行ける場所をキューに入れる
237　すべて行ったかチェック
