...
85 returnでpnodeの値を返す

109 cnを0で初期化

111 while文を用いてpListがNULLでない限り繰り返す
...
120 探したいIDでないときは次のIDに移動する

121 cnを一つ進める

125 探したいIDがないときはreturnで-1を返す
